...
async def setup():
    ...
    s2 = Story(
        id="s2",
        name="Dashboard",
        description="Build main dashboard view",
        status="pending",
    )
    s3 = Story(
        id="s3",
    ...
    await task_store.put_task(
        Task(
            ...
            description="Main grid layout",
            story_id="s2",
            status="pending",
            agent="designer",
            repository_name="ui-kit",
        )
    )
    await task_store.put_task(
        Task(
            id="t5",
            name="Metrics widgets",
    ...
    await task_store.put_task(
        Task(
            ...
            status="ready",
            agent="devops-bot",
            repository_name="notification-svc",
            checklist=[
    ...
    await task_store.put_task(
        Task(
            ...
            description="Repair broken tests",
            status="in_progress",
            agent="devops-bot",
